	...
	return (
		<HStack gap={'16'} justify={'center'} align={'center'} className={classes.counter}>
			...
			<VStack className={classes.buttons} gap={'8'} justify={'center'} align={'center'}>
				<Button className={classes.button} theme={ButtonThemeEnum.ROUNDED} onClick={handleIncrement}>Increment Counter</Button>
				<Button className={classes.button} theme={ButtonThemeEnum.ROUNDED} onClick={handleDecrement}>Decrement Counter</Button>
				<Button className={classes.button} theme={ButtonThemeEnum.ROUNDED} onClick={handleAdd}>Add 5</Button>
			</VStack>
		</HStack>
	);
};
