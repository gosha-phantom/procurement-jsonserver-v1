...
import {
	useTable, useGlobalFilter, useFilters, useSortBy, usePagination, useRowSelect,
} from 'react-table';
...
export const ColumnHidingReactTable = () => {
		...
		<div className="container">
			<div>
				<div style={{ display: 'flex', gap: '1rem' }}>
					<CheckboxRowSelect {...getToggleHideAllColumnsProps()}/>
					<span>Переключить все столбцы</span>
				</div>
